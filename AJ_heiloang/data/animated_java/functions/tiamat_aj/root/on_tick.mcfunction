...
execute if entity @s[tag=aj.tiamat_aj.animation.3_5_cast_start_dive.playing] run function animated_java:tiamat_aj/animations/3_5_cast_start_dive/zzz/on_tick
execute if entity @s[tag=aj.tiamat_aj.animation.3_6_casting_dive.playing] run function animated_java:tiamat_aj/animations/3_6_casting_dive/zzz/on_tick
execute if entity @s[tag=aj.tiamat_aj.animation.3_7_cast_start_breath.playing] run function animated_java:tiamat_aj/animations/3_7_cast_start_breath/zzz/on_tick
execute if entity @s[tag=aj.tiamat_aj.animation.3_8_casting_breath.playing] run function animated_java:tiamat_aj/animations/3_8_casting_breath/zzz/on_tick
