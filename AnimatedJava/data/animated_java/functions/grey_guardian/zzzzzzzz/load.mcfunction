...
scoreboard objectives add aj.grey_guardian.animation.backstep.local_anim_time dummy
...
scoreboard objectives add aj.grey_guardian.animation.backstep.loop_mode dummy
...
scoreboard players set $aj.grey_guardian.animation.backstep aj.id 3
scoreboard players set $aj.grey_guardian.animation.attack1 aj.id 4
scoreboard players set $aj.grey_guardian.animation.attack2 aj.id 5
scoreboard players set $aj.grey_guardian.animation.attack3 aj.id 6
scoreboard players set $aj.grey_guardian.animation.attack4 aj.id 7
scoreboard players set $aj.grey_guardian.animation.attack5 aj.id 8
scoreboard players set $aj.grey_guardian.animation.dead aj.id 9
