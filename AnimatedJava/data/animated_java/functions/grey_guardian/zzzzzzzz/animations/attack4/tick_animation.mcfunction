...
execute if score @s aj.grey_guardian.animation.attack4.local_anim_time matches 66.. run function animated_java:grey_guardian/zzzzzzzz/animations/attack4/end