...
execute if score @s aj.grey_guardian.animation.backstep.local_anim_time matches 40.. run function animated_java:grey_guardian/zzzzzzzz/animations/backstep/end