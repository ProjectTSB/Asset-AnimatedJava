...
execute if score @s aj.grey_guardian.animation.attack5.local_anim_time matches 73.. run function animated_java:grey_guardian/zzzzzzzz/animations/attack5/end