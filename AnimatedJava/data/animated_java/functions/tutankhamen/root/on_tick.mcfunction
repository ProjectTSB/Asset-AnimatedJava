...
execute if entity @s[tag=aj.tutankhamen.animation.attack_laser_2_loop.playing] run function animated_java:tutankhamen/animations/attack_laser_2_loop/zzz/on_tick
execute if entity @s[tag=aj.tutankhamen.animation.attack_laser_2_end.playing] run function animated_java:tutankhamen/animations/attack_laser_2_end/zzz/on_tick
...
execute on passengers if entity @s[tag=aj.tutankhamen.data] run function animated_java:tutankhamen/root/zzz/1
