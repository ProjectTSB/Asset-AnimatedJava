...
scoreboard players set $aj.tutankhamen.animation.rod_ground_end aj.id 10
scoreboard players set $aj.tutankhamen.animation.dash_slash aj.id 11
scoreboard players set $aj.tutankhamen.animation.beam_long aj.id 12
scoreboard players set $aj.tutankhamen.animation.beam_long_charge aj.id 13
scoreboard players set $aj.tutankhamen.animation.beam_long_shot aj.id 14
scoreboard players set $aj.tutankhamen.animation.soul_shot aj.id 15
scoreboard players set $aj.tutankhamen.animation.death aj.id 16
scoreboard players set $aj.tutankhamen.animation.spawn aj.id 17
