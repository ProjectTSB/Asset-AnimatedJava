...
execute if score @s aj.red_knight.animation.attack_projectile_1.local_anim_time matches 54.. run function animated_java:red_knight/zzzzzzzz/animations/attack_projectile_1/end