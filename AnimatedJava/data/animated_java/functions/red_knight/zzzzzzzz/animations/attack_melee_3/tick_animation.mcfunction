...
execute if score @s aj.red_knight.animation.attack_melee_3.local_anim_time matches 58.. run function animated_java:red_knight/zzzzzzzz/animations/attack_melee_3/end