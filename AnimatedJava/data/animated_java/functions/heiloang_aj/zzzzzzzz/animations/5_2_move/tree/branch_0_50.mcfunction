execute if score @s aj.anim_time matches 0..7 run function animated_java:heiloang_aj/zzzzzzzz/animations/5_2_move/tree/branch_0_7
execute if score @s aj.anim_time matches 8..15 run function animated_java:heiloang_aj/zzzzzzzz/animations/5_2_move/tree/branch_8_15
execute if score @s aj.anim_time matches 16..23 run function animated_java:heiloang_aj/zzzzzzzz/animations/5_2_move/tree/branch_16_23
