...
execute if entity @s[tag=aj.heiloang_aj.animation.3_2_hellfire_shoot_end2] run function animated_java:heiloang_aj/zzzzzzzz/animations/3_2_hellfire_shoot_end2/tick
