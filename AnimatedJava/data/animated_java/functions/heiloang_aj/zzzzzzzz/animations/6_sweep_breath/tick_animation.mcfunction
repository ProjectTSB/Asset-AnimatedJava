...
execute if score @s aj.heiloang_aj.animation.6_sweep_breath.local_anim_time matches 105.. run function animated_java:heiloang_aj/zzzzzzzz/animations/6_sweep_breath/end