...
execute if score #animation aj.i = $aj.frestchika_v2.animation.1_0_former_warp_pre aj.id run function animated_java:frestchika_v2/zzzzzzzz/animations/1_0_former_warp_pre/apply_frame_as_root
execute if score #animation aj.i = $aj.frestchika_v2.animation.1_0_former_warp_pre aj.id run scoreboard players operation @s aj.frestchika_v2.animation.1_0_former_warp_pre.local_anim_time = #frame aj.i
execute if score #animation aj.i = $aj.frestchika_v2.animation.1_1_former_warp_slash aj.id run function animated_java:frestchika_v2/zzzzzzzz/animations/1_1_former_warp_slash/apply_frame_as_root
execute if score #animation aj.i = $aj.frestchika_v2.animation.1_1_former_warp_slash aj.id run scoreboard players operation @s aj.frestchika_v2.animation.1_1_former_warp_slash.local_anim_time = #frame aj.i
...
execute if score #animation aj.i = $aj.frestchika_v2.animation.3_0_former_sonic_slash aj.id run function animated_java:frestchika_v2/zzzzzzzz/animations/3_0_former_sonic_slash/apply_frame_as_root
execute if score #animation aj.i = $aj.frestchika_v2.animation.3_0_former_sonic_slash aj.id run scoreboard players operation @s aj.frestchika_v2.animation.3_0_former_sonic_slash.local_anim_time = #frame aj.i
...
execute if score #animation aj.i = $aj.frestchika_v2.animation.5_0_former_thunder_bomb aj.id run function animated_java:frestchika_v2/zzzzzzzz/animations/5_0_former_thunder_bomb/apply_frame_as_root
execute if score #animation aj.i = $aj.frestchika_v2.animation.5_0_former_thunder_bomb aj.id run scoreboard players operation @s aj.frestchika_v2.animation.5_0_former_thunder_bomb.local_anim_time = #frame aj.i
...
execute if score #animation aj.i = $aj.frestchika_v2.animation.102_0_later_funnel aj.id run function animated_java:frestchika_v2/zzzzzzzz/animations/102_0_later_funnel/apply_frame_as_root
execute if score #animation aj.i = $aj.frestchika_v2.animation.102_0_later_funnel aj.id run scoreboard players operation @s aj.frestchika_v2.animation.102_0_later_funnel.local_anim_time = #frame aj.i
execute if score #animation aj.i = $aj.frestchika_v2.animation.103_0_later_sonic_slash aj.id run function animated_java:frestchika_v2/zzzzzzzz/animations/103_0_later_sonic_slash/apply_frame_as_root
execute if score #animation aj.i = $aj.frestchika_v2.animation.103_0_later_sonic_slash aj.id run scoreboard players operation @s aj.frestchika_v2.animation.103_0_later_sonic_slash.local_anim_time = #frame aj.i
execute if score #animation aj.i = $aj.frestchika_v2.animation.104_0_later_gun aj.id run function animated_java:frestchika_v2/zzzzzzzz/animations/104_0_later_gun/apply_frame_as_root
execute if score #animation aj.i = $aj.frestchika_v2.animation.104_0_later_gun aj.id run scoreboard players operation @s aj.frestchika_v2.animation.104_0_later_gun.local_anim_time = #frame aj.i
execute if score #animation aj.i = $aj.frestchika_v2.animation.105_0_later_thunder_crisis aj.id run function animated_java:frestchika_v2/zzzzzzzz/animations/105_0_later_thunder_crisis/apply_frame_as_root
execute if score #animation aj.i = $aj.frestchika_v2.animation.105_0_later_thunder_crisis aj.id run scoreboard players operation @s aj.frestchika_v2.animation.105_0_later_thunder_crisis.local_anim_time = #frame aj.i
