...
$execute on passengers run data modify entity @s[tag=aj.blazing_inferno.bone.body] {} merge from storage aj.blazing_inferno:animations attack_shoot_2.$(frame).bone_body
$execute on passengers run data modify entity @s[tag=aj.blazing_inferno.bone.left_hand] {} merge from storage aj.blazing_inferno:animations attack_shoot_2.$(frame).bone_left_hand
$execute on passengers run data modify entity @s[tag=aj.blazing_inferno.bone.left_arm] {} merge from storage aj.blazing_inferno:animations attack_shoot_2.$(frame).bone_left_arm
$execute on passengers run data modify entity @s[tag=aj.blazing_inferno.bone.right_hand] {} merge from storage aj.blazing_inferno:animations attack_shoot_2.$(frame).bone_right_hand
