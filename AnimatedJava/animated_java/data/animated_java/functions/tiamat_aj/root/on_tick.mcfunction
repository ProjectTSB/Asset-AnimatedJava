...
execute if entity @s[tag=aj.tiamat_aj.animation.11_death3.playing] run function animated_java:tiamat_aj/animations/11_death3/zzz/on_tick
execute if entity @s[tag=aj.tiamat_aj.animation.11_death2.playing] run function animated_java:tiamat_aj/animations/11_death2/zzz/on_tick
