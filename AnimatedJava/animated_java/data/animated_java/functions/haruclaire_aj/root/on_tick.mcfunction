...
execute if entity @s[tag=aj.haruclaire_aj.animation.29_0_second_move_forward.playing] run function animated_java:haruclaire_aj/animations/29_0_second_move_forward/zzz/on_tick
