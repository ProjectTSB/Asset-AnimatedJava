...
$execute on passengers run data modify entity @s[tag=aj.ic_pisce_aj.bone.head3] {} merge from storage aj.ic_pisce_aj:animations 0_start.$(frame).bone_head3
$execute on passengers run data modify entity @s[tag=aj.ic_pisce_aj.bone.arm_right3] {} merge from storage aj.ic_pisce_aj:animations 0_start.$(frame).bone_arm_right3
$execute on passengers run data modify entity @s[tag=aj.ic_pisce_aj.bone.arm_left3] {} merge from storage aj.ic_pisce_aj:animations 0_start.$(frame).bone_arm_left3
$execute on passengers run data modify entity @s[tag=aj.ic_pisce_aj.bone.body3] {} merge from storage aj.ic_pisce_aj:animations 0_start.$(frame).bone_body3
