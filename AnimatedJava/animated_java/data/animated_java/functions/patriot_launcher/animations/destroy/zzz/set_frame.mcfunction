...
$execute on passengers run data modify entity @s[tag=aj.patriot_launcher.bone.missile1] {} merge from storage aj.patriot_launcher:animations destroy.$(frame).bone_missile1
