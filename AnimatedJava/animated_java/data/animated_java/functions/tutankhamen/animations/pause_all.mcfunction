...
tag @s remove aj.tutankhamen.animation.attack_laser_windup.playing
tag @s remove aj.tutankhamen.animation.attack_laser_loop.playing
tag @s remove aj.tutankhamen.animation.attack_laser_end.playing
